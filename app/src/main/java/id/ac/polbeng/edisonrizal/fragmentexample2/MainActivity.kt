package id.ac.polbeng.edisonrizal.fragmentexample2
...
import id.ac.polbeng.edisonrizal.fragmentexample2.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!fragBookTitle.isInLayout) {
            supportFragmentManager
                .beginTransaction()
                .replace(binding.fragtop.id, fragBookTitle, BOOK_TITLE_TAG)
                .replace(binding.fragbottom.id, fragBookDescription, BOOK_DESCRIPTION_TAG)
                .commit()
        }
    }
